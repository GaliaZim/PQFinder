...
public class LeafMappingTest {
    ...
    private static Stream<Arguments> LeafMappingTestProvider() {
        ...
        return Stream.of(
                Arguments.of("123423145682", new Node(1, NodeType.LEAF, "cog2", emptyList), 0, 0),
                Arguments.of("123423145682", new Node(1, NodeType.LEAF, "cog2", emptyList), 2, 3),
                Arguments.of("1", new Node(1, NodeType.LEAF, "cog5", emptyList), 2, 1),
                Arguments.of("", new Node(1, NodeType.LEAF, "cog5", emptyList), 2, 1),
                Arguments.of("156253451525", new Node(1, NodeType.LEAF, "cog5", emptyList), 0, 1),
                Arguments.of("156253451525", new Node(1, NodeType.LEAF, "cog5", emptyList), 2, 0)
        );
    }
